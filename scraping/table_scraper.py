...
for url in url_list['urls']:
    ...
    with dw.open_remote_file('rustygentile/ncaa-etl', home_csv) as w:
        home_table.to_csv(w, index=False)
        
    with dw.open_remote_file('rustygentile/ncaa-etl', away_csv) as w:
        away_table.to_csv(w, index=False)

    with dw.open_remote_file('rustygentile/ncaa-etl', game_csv) as w:
